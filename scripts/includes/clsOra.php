...
class Database {
    ...
    function __construct() {
        ...
        $connection_string = "181.214.99.122:1521/FREE";

        $this->conn = oci_connect(ORAUSER, ORAPASSWD, $connection_string, "AL32UTF8");
...
public function callFunctionToRS(string $plsql, array $inBinds, string $outName = 'result', int $outType = SQL_INTEGER, int $outSize = 4000        // genug Platz für VARCHAR2
) {
